...
1. Clone Project Code
   ...
   ```
   git clone https://github.com/AndyNguyen1010/udacity_project.git
   ```

### Project Structure

1. [.bin](https://github.com/AndyNguyen1010/udacity_project/tree/main/.bin): Bash file to complete project
2. [db](https://github.com/AndyNguyen1010/udacity_project/tree/main/db): Scripts to seed data
3. [deployment](https://github.com/AndyNguyen1010/udacity_project/tree/main/deployment): Kubernetes yaml files
4. [terraform](https://github.com/AndyNguyen1010/udacity_project/tree/main/terraform): Terraform file to create AWS resource
5. [screenshots](https://github.com/AndyNguyen1010/udacity_project/tree/main/screenshots): Screenshots
